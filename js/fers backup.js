...
//Capture all #selectTwos
//Find it in the hash and return corresponding value
//add together


$('#findvalues').click(function() {

  var workoutValue = $('.training-method').text();
   
   for (var i=0; i < game.cardio_labels.length; i++) {
        if (game.cardio_labels[i].match(workoutValue)) 
            {console.log(i) }
    }
    return -1;
